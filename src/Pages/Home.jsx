                ...
                <section className="py-[30px] md:px-[50px]">
                    <div className="flex flex-row flex-wrap">
                        ...
                        <div className="basis-1/1 md:basis-2/3 flex flex-wrap flex-row gap-5 justify-center">
                            ...
                            <div data-aos="slide-right" data-aos-duration="1600" className="basis-1/1 md:basis-1/2 text-center border py-[20px]">
                            ...
                            <div data-aos="slide-down" data-aos-duration="800" className="basis-1/1 md:basis-1/2 border text-center py-[20px]">
                            ...
                            <div data-aos="slide-left" data-aos-duration="1600" className="basis-1/1 md:basis-1/2 border text-center py-[20px]">
